...
for i in Genomes_pair: #Here we are stripping tabs and spaces from file names 
	...
	os.system("fastqc ~/Campy_Genomes/" +RefGenome+ "/" +RefGenome+ "s1_*  ~/Campy_Genomes/" +RefGenome+ "/" +RefGenome+ "s2_* --outdir=/mnt/gs18/scratch/groups/manninglab/Cattle_All_QC_Results/fastqc/" + RefGenome)
